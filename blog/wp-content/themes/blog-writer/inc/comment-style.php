			...
			<div class="comment-details clr media-body comment_body">
				<header class="comment-meta">
					...
					'<a href="%1$s"><time datetime="%2$s">%3$s</time></a>',
						...
						esc_attr_x( 'Commented on %1$s', 'The date', 'blog-writer' ), get_comment_date() )); ?> 
					
				<span class="reply comment-reply-link">
					<?php comment_reply_link( array_merge( $args, array(
						'reply_text' => esc_html__( '&ndash; Reply', 'blog-writer' ),
						'depth'      => $depth,
				...
				<?php if ( '0' == $comment->comment_approved ) : ?>
					<p class="comment-awaiting-moderation"><?php esc_html_e( 'Your comment is awaiting moderation.', 'blog-writer' ); ?></p>
				<?php endif; ?>
