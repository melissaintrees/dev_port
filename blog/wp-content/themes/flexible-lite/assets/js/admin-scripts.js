...
jQuery(document).ready(function($){
	...
	$('#page_template').change(function() {
    	$('#flexible_lite_page_icon').toggle($(this).val() == 'templates/flexible-lite-services.php');
   	}).change();

   	/**
     * Image uploader
     */
    upload_media_image('.flexible-lite-upload-button');
    delete_media_image('.flexible-lite-delete-button');    
